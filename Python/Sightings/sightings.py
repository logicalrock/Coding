'''
Training Objective:
By showing how something that appears harmless (like a log analyzer) can embed fully functional payloads, you’re giving your DevSecOps team practical exposure to:

🔍 Threat modeling real-world scenarios

🧠 Understanding the subtlety of obfuscation

✅ Establishing why strict code review policies matter
